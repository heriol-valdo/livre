...
if(filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
   ...
   // Exécution ! La recette est maintenant en base de données
    ...
    imap_mail("zeufackheriol9@gmail.com","Confirmation de reception du message du message du visiteur sur le site livre ", "Monsieur ou Madamme  t'ecris via le site livre voici son message: ". $_POST['message'], "From:".$_POST['email']);
