    ...
    <div class="row">
      <div class="col-md-4 col-sm-12 pt-2">
        <div class="card"><img class="img-fluid card-img-top" src="images/2.jpg" alt="2-start-simple"/>
          <div class="card-body">
            <p class="text-muted">
                Creation and development of websites, mobile applications, maintenance of information systems according to your wishes.</p><a class="card-link" target="_blank"   href="https://sites.heriolvaldo.com" style="color:blue;">Learn More</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 col-sm-12 pt-2">
        <div class="card"><img class="img-fluid card-img-top" src="images/3.jpg" alt="3-start-simple"/>
          <div class="card-body">
            <p class="text-muted">PAdvice and proposals for mobile and web models for your application.</p><a class="card-link" href="https://sites.heriolvaldo.com" style="color:blue;"  target="_blank">Learn More</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 col-sm-12 pt-2">
        <div class="card"><img class="img-fluid card-img-top" src="images/4.jpg" alt="4-start-simple"/>
          <div class="card-body">
            <p class="text-muted">photography services for different events allowing people to immortalize special family moments</p><a class="card-link" href="https://galerie.heriolvaldo.com"     target="_blank" style="color:blue;">Learn More</a>
          </div>
        </div>
      </div>
    </div>
